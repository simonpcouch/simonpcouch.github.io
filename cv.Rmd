...
•  Relevant Coursework: Statistics Practicum, Machine Learning, Data Science, Introduction to Probability and Statistics, Computer Science Fundamentals, Vector Calculus, Linear Algebra  

<br>

## Technical Experience 
**Data Science Intern** | *John Deere*  
*Olathe, Kansas* | *May 2019 -- Present*  
•	Design, implement, and maintain a suite of tools to validate data integrity of 12 automated business reports with a collective internal viewership of over 10,000 using Python, R, PostgreSQL, and Spark SQL  
•	Construct 7 Tableau dashboards combining insights from 4 surveys conducted across time on similar topics, making use of reproducible R data tidying for future adaptability  
•	Model geospatial customer behavior using ArcGIS Pro and Python  
...
## Publications 
**Encouraging Equitable Bikeshare: Implications of Docked and Dockless Models for Spatial Equity**| *arXiv*  
*In Review* | *2019*  
...
## Skills 
**R** *(Advanced)* | **Python** *(Intermediate)* | **SQL** *(Intermediate)* | **Git & GitHub** *(Intermediate)* | **LaTeX** *(Intermediate)* | **ArcGIS** *(Basic)*
