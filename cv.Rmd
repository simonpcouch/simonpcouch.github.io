...
•  Relevant Coursework: Statistics Practicum (MATH 343), Data Science (MATH 241), Machine Learning (MATH 243), Deep Learning (CSCI 378), Probability (MATH 391), Mathematical Statistics (MATH 392), Vector Calculus (MATH 202), Linear Algebra (MATH 201), Gender & Work (SOC 322), Science & Social Difference (SOC 326), Race & Racism (SOC 343)  
...
•	Collaborate with student and faculty researchers to efficiently and thoughtfully make use of data technologies to advance research goals across fields as varied as economics, linguistics, sociology, and biology  
...
•	Write, optimize, test, and maintain large bodies of R code to carry out power analysis of differentially private hypothesis tests  
...
## Publications 
[**Differentially Private Nonparametric Hypothesis Testing** *(2019)*](https://dl.acm.org/citation.cfm?id=3319535.3339821)  
...
[**Encouraging Equitable Bikeshare: Implications of Docked and Dockless Models for Spatial Equity** *(2019)*](https://arxiv.org/abs/1906.00129)     
...
## Skills 
**R** *(Advanced)*  | **ArcGIS** *(Intermediate)* | **Tableau** *(Intermediate)* | **SQL** *(Intermediate)* | **Git & GitHub** *(Intermediate)* | **LaTeX** *(Intermediate)*  | **Python** *(Basic)* | **CSS** *(Basic)* | **Jupyter** *(Basic)*  
...
## Honors & Awards    
**Goldwater Nominee** | *Reed College*  
*Portland, Oregon* | *November 2018, 2019*  
One of four students chosen to represent Reed College as a nominee for the nationally competitive scholarship seeking "to identify and support college sophomores and juniors who show exceptional promise of becoming this Nation’s next generation of research leaders in these fields."  

**2nd Place (tied)---Undergraduate Statistics Research Project Competition** | *American Statistical Association*  
...
**1st Place (tied)---Undergraduate Statistics Research Project Competition** | *American Statistical Association*  
...
## Presentations 
**Encouraging Equitable Bikeshare** | *Electronic Undergraduate Statistics Research Conference*  
